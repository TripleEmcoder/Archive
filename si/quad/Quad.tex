...
Zgodnie z przewidywaniami wprowadzenie wariantu \emph{FailSafe} + \emph{TranspositionTable} daje wyraŸne zmiejszenie iloœci przegl¹danych wierzcho³ków, a co za tym idzie poprawienie wydajnoœci. Jak pokazuj¹ dane z pomiarów, zdarzaj¹ siê przypadki, w których wariant ten wypada nieco gorzej -- wynika to z wykonywania przez niego iteracyjnego pog³êbiania, które mo¿e niezniacznie zwiêkszaæ liczbê przegl¹danych wierzcho³ków. Jest to jednak rzadkie zjawisko.
