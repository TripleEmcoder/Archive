...
--
DROP TABLE IF EXISTS `drupal_mailq_archive`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `drupal_mailq_archive` (
  ...
  `archive_stamp` int(11) default '0',
  PRIMARY KEY  (`mailq_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

LOCK TABLES `drupal_mailq_archive` WRITE;
/*!40000 ALTER TABLE `drupal_mailq_archive` DISABLE KEYS */;
/*!40000 ALTER TABLE `drupal_mailq_archive` ENABLE KEYS */;
UNLOCK TABLES;
