/****** Object:  Table [dbo].[Groups]    Script Date: 11/03/2007 19:29:00 ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[Articles]    Script Date: 11/03/2007 19:28:59 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Postings]    Script Date: 11/03/2007 19:29:01 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[ArticleHeaders]    Script Date: 11/03/2007 19:28:57 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[ArticleBodies]    Script Date: 11/03/2007 19:28:56 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  View [dbo].[GroupOverviews]    Script Date: 11/03/2007 19:29:01 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS
SELECT     dbo.Groups.ID, dbo.Groups.Name, COUNT(dbo.Postings.ArticleID) AS Count, ISNULL(MIN(dbo.Postings.ArticleID), 0) AS Low, ISNULL(MAX(dbo.Postings.ArticleID), 0) 
                      AS High
FROM         dbo.Groups LEFT OUTER JOIN
                      dbo.Postings ON dbo.Postings.GroupID = dbo.Groups.ID
GROUP BY dbo.Groups.ID, dbo.Groups.Name
GO
/****** Object:  ForeignKey [FK_ArticleBodies_Articles]    Script Date: 11/03/2007 19:28:56 ******/
...
GO
/****** Object:  ForeignKey [FK_ArticleHeaders_Articles]    Script Date: 11/03/2007 19:28:57 ******/
...
GO
/****** Object:  ForeignKey [FK_Articles_Articles]    Script Date: 11/03/2007 19:28:59 ******/
...
GO
/****** Object:  ForeignKey [FK_Groups_Groups]    Script Date: 11/03/2007 19:29:00 ******/
...
GO
/****** Object:  ForeignKey [FK_Postings_Articles]    Script Date: 11/03/2007 19:29:01 ******/
...
GO
/****** Object:  ForeignKey [FK_Postings_Groups]    Script Date: 11/03/2007 19:29:01 ******/
