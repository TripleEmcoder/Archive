...
\item sumaryczna d³ugoœæ okresów pracy zaplanowanych na I maszynie musi byæ równa czasowi zadanemu w instancji, czyli:
$$\forall i=1,2,\ldots,n: \sum_{j=1}^{k_i} p'_{ij} = p'_i$$

\item przetwarzanie na maszynie II musi rozpocz¹æ siê natychmiast po zakoñczeniu przetwarzania na maszynie I, czyli:
$$\forall i=1,2,\ldots,n: r'_{ik_i} + p'_{ik_i} = r''_i$$

\item niemo¿liwe jest przetwarzanie w podczas okresu niedostêpnoœci oraz jednoczesne przetwarzanie wiêcej ni¿ jednej czêœci tego samego zadania lub ró¿nych zadañ, czyli
$$\bigcap_{j=1}$$
\end{itemize}
