...
Do rozwi¹zania postawionego problemu wykorzystany zosta³ ogólny schemat algorytmu typu \emph{tabu search}.
\section{Usprawnienia algorytmu}
\subsection{Ograniczenie liczby ruchów}
\subsection{Zach³anna inicjalizacja}
\section{(przyk³ad na ma³ej instancji)}
\section{(bad case)}
