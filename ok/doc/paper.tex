...
\begin{itemize}
\item dla ka¿dego zadania czasy przetwarzania na obu maszynach zawieraj¹ siê w przedziale $\left[ 1, 100\right]$ jednoste, czyli:
\begin{displaymath}
...
& \left[ r'_{i_1j_1} - s'_{i_1j_1}, r'_{i_1j_1} +p '_{i_1j_1} \right)
\cap
\left[ r'_{i_2j_2} - s'_{i_2j_2}, r'_{i_2j_2} +p '_{i_2j_2} \right)
=
\emptyset
\end{eqnarray*}
