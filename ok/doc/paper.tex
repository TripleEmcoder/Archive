...
[ca³ka Stieltiesa]
Niech zmienna losowa $X$ odpowiada czasowi przetwarzania na I maszynie, a zmienna losowa $Y$ czasowi przygotowania na I maszynie. Zmienna $X$ przyjmuje wartoœci $x_i$ dla $i=2,3,\ldots,100$, gdzie $x_i$ odpowiada czasowi przetwarzania równemu $i$ jednostek czasu. Rozk³ad zmiennej $X$ jest równomierny, zatem:
