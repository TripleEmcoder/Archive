...
\begin{figure}[h]
\centering
\includegraphics[width=0.9\textwidth]{cmax_distance_move}
\end{figure}

- du¿a poprawa dla pierwszych kilku, póŸniej coraz mniejsza, wynika z tego, ¿e dalekie ruch s¹ rzadko wykonywane

-!!! distance oznacza tutaj maksymaln¹ odleg³oœæ w lewo + maksymaln¹ odl. w prawo !!!! trzeba to jakoœ objaœniæ albo zmieniæ
...
- du¿a poprawa mniej wiêcej do distance 20, póŸniej mniejsza, z tego samego powodu co dla MoveIndex


- teraz albo tu, albo dla ka¿dego osobno trzeba daæ te wykresy czêstoœci wyboru ruchu

\begin{figure}[h]
\centering
\includegraphics[width=0.8\textwidth]{cmax_distance_50}
\end{figure}

- move bardziej op³acalny dla ma³ego distance, swap dla du¿ego
