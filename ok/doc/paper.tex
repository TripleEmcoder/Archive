...
\ref{fig:cmax-tabus-75} prowadzi do wniosku, ¿e ów ,,do³ek'', czyli obszar o najmniejszym b³êdzie wzglêdnym, wystêpuje dla $\emph{tabus} \approx \SI{30}{\%}\;moves$, gdzie $moves$ to iloœæ mo¿liwych ruchów, okreœlona wzorem z punktu \ref{seq:upgrades}.
