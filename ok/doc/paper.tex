...
Ostatnim z etapów eksperymentu by³ test wydajnoœciowy, który mia³ na celu pokazanie jak algorytm zachowuje siê dla ró¿nych liczb zadañ przy ustalonych wczeœniej parametrach. Wykres na rysunki \ref{fig:speed} przedstawia wyniki pomiarów, oraz idealnie dopasowane do nich krzywe wielomianowe. Potwierdza to w sposób ostateczny wyznaczon¹ z³o¿onoœæ rzêdu $O(n^2)$.
