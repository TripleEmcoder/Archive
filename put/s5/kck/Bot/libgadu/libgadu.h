/* coding: UTF-8 */
/* $Id: libgadu.h 6003 2007-07-26 16:00:19Z ono $ */
...
#define LIBGADU_API __declspec(dllexport)
#else
#define LIBGADU_API __declspec(dllimport)
#endif
...
LIBGADU_API struct gg_session *gg_login(const struct gg_login_params *p);
LIBGADU_API void gg_free_session(struct gg_session *sess);
LIBGADU_API void gg_logoff(struct gg_session *sess);
LIBGADU_API int gg_change_status(struct gg_session *sess, int status);
LIBGADU_API int gg_change_status_descr(struct gg_session *sess, int status, const char *descr);
LIBGADU_API int gg_change_status_descr_time(struct gg_session *sess, int status, const char *descr, int time);
LIBGADU_API int gg_send_message(struct gg_session *sess, int msgclass, uin_t recipient, const unsigned char *message);
LIBGADU_API int gg_send_message_richtext(struct gg_session *sess, int msgclass, uin_t recipient, const unsigned char *message, const unsigned char *format, int formatlen);
LIBGADU_API int gg_send_message_confer(struct gg_session *sess, int msgclass, int recipients_count, uin_t *recipients, const unsigned char *message);
LIBGADU_API int gg_send_message_confer_richtext(struct gg_session *sess, int msgclass, int recipients_count, uin_t *recipients, const unsigned char *message, const unsigned char *format, int formatlen);
LIBGADU_API int gg_send_message_ctcp(struct gg_session *sess, int msgclass, uin_t recipient, const unsigned char *message, int message_len);
LIBGADU_API int gg_ping(struct gg_session *sess);
LIBGADU_API int gg_userlist_request(struct gg_session *sess, char type, const char *request);
LIBGADU_API int gg_image_request(struct gg_session *sess, uin_t recipient, int size, uint32_t crc32);
LIBGADU_API int gg_image_reply(struct gg_session *sess, uin_t recipient, const char *filename, const char *image, int size);

LIBGADU_API uint32_t gg_crc32(uint32_t crc, const unsigned char *buf, int len);
...
LIBGADU_API extern int gg_debug_level;
